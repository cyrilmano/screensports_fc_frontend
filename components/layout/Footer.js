    ...
    <footer className="bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div className="absolute top-40 right-20 w-16 h-16 bg-green-600 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="animate-fadeInUp" style={{animationDelay: '0.1s'}}>
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-green-600 rounded-full flex items-center justify-center animate-bounceIn">
          ...
          <div className="animate-fadeInUp" style={{animationDelay: '0.7s'}}>
            ...
            <form className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-green-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-green-700 transition-all duration-200 transform hover:scale-105 hover-lift"
              >
                Subscribe
              </button>
            </form>
