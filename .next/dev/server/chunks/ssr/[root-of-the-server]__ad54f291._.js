...
"[project]/app/news/[id]/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewsArticle({ params }) {
    ...
    // or just access if it's passed as a promise in server components.
    // However, since we are using 'use client' to avoid potential server-side issues with simple static data for now,
    // we can try to treat it as a standard component. 
    // BUT, in Next.js App Router, pages are server components by default.
    // Let's stick to Server Component pattern which is standard.
    // Re-writing this to be a Server Component.
    return null;
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad54f291._.js.map